...
AA AS (
    ...
    WHERE AA."NrBank" <> '042'
        ...
        AND (
            EXISTS (SELECT 1 FROM PBI."SPAccGosInclude" I
                    WHERE I."PrYSR" = 1 AND I."count_NrAccount" = 2
                      AND I."NrAccountOrder" = AA."BalAccount2")
            OR EXISTS (SELECT 1 FROM PBI."SPAccGosInclude" I
                       WHERE I."PrYSR" = 1 AND I."count_NrAccount" = 3
                         AND I."NrAccountOrder" = AA."BalAccount3")
            OR EXISTS (SELECT 1 FROM PBI."SPAccGosInclude" I
                       WHERE I."PrYSR" = 1 AND I."count_NrAccount" = 4
                         AND I."NrAccountOrder" = AA."BalAccount4")
        )
        AND NOT EXISTS (
